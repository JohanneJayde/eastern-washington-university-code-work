...
Course#: CSCD211-F20
Description: created during class. This program explains how to use doubly LinkedList. This is a 
variation of LinkedList that allows double linkages to next and previous node in a LinkedList
this program shows how to implement them, add to a particular index, add element to the end of
the list, remove based on index, remove a value searched by the user, find out LinkedList size, and
find out whether or not the list is empty.
*/
...
class DLinkedList
{
    ...
    */
    ...
    public String remove(int index)
    {
       ...
       String element = target.element;  // Element to return
    ...
    */
    ...
    public boolean remove(String element)
    {
       ...
       // Locate the node targeted for removal
       Node target = first;  
       while (target != null && !element.equals(target.element))
           target = target.next;
