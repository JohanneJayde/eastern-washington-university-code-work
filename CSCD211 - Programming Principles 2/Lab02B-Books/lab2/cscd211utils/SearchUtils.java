 ...
 *
 * <br>NOTE The class uses generic for the type. Please note the &lt;T&gt; on the class header
 */
public class SearchUtils <T>
{
   /**
    * The linearSearch functions walks the array element by element looking
    * for the target.  If the target is found the index of the first occurrence of the
    ...
    * @return int Representing the index of the first occurrence of target or -1 if the item is not found
    *
