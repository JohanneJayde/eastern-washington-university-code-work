...
public class Tester {
	...
	public int countSpace(String str) {	
		...
		int numSpaces = countSpace(str.substring(1));
			
		if(Character.isWhitespace(str.charAt(0))) {
			return ++numSpaces;
		}
				
		return numSpaces; //change this line of code as needed.
	}
	...
	public int div(int m, int n) throws IllegalArgumentException {
		...
		int numMultipes = div(m - n, n);
		
		if(n <= m) {
			return ++numMultipes;
		}
		
		return numMultipes;//change this line of code as needed.
	}
